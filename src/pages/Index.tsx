  ...
  return (
    <div className="min-h-screen bg-gaming-black text-white font-roboto">
      ...
      <section className="relative overflow-hidden py-20 bg-gradient-to-br from-gaming-black via-gaming-gray to-gaming-black">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23FF0080" fill-opacity="0.1"%3E%3Ccircle cx="30" cy="30" r="1"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-20"></div>
